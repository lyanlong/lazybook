...
<head>
    ...
    <link rel="stylesheet" href="/css/lazybook-admin.css">
...
<nav class="navbar navbar-expand-sm navbar-dark bg-dark"><!--@admin-only-->
    ...
    <div class="collapse navbar-collapse" id="navbarsExampleDefault">
        <ul class="navbar-nav mr-auto">
            ...
            <li class="nav-item dropdown">
                <a class="nav-link dropdown-toggle" href="#" id="tool-dropdown" data-toggle="dropdown"
                   aria-haspopup="true"
                   aria-expanded="false">小工具</a>
                <div class="dropdown-menu" aria-labelledby="tool-dropdown">
                    <?php foreach ($toollist as $key => $tool): ?>
                        <a class="dropdown-item tool-dropdown-item" href="#" data-href="<?= $tool['url'] ?>"><?=$tool['name'] ?></a>
                    <?php endforeach; ?>
                </div>
            </li>
        </ul>
...
<div class="container-fluid">
    <div class="row" id="global-search-row">
        ...
        <div class="col-8">
            ...
            <button class="btn btn-primary" id="refresh-book-log">更新搜索库</button><!--@admin-only-->
        </div>
        <div class="col-2"></div>
    </div>
    <div class="row" id="lazybook-main">
        ...
        <div class="col-10" id="tool-content"><!--@admin-only-->
...
<div class="modal fade" id="myModal-createDFile" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"><!--@admin-only-->
...
<div class="modal fade" id="upload-article-modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"><!--@admin-only-->
